...
Le plugin permet d'installer des MIBs spécifiques en plaçant les fichiers correspondant, par exemple SYNOLOGY-SYSTEM-MIB.txt,  dans le répertoire plugins\SNMP3\data\mibs. 
